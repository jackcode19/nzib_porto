...
function Navbar() {
  ...
  return (
    <nav className="w-full bg-transparent px-4 flex justify-around items-center fixed backdrop-blur-md md:backdrop-blur-sm p-5 shadow-md z-50">
      <div className="hidden md:flex">
        <ul className="flex justify-center items-center font-normal ">
      ...
      <div className="md:hidden w-full flex justify-center relative">
        {toggleMenu ? (
          <AiOutlineClose
            fontSize={28}
            className="text-white cursor-pointer absolute top-0 right-1"
        ...
        {toggleMenu && (
          <ul className="w-full flex h-screen flex-col justify-center items-center font-medium animate-fade-in">
            {NavbarItem?.map((menu, index) => (
              <li
                key={index}
